...
<body>
	...
	try{
		...
		String str = "SELECT flightNum, airline, airportTo, airportFrom, workingDays, numOfSeats, fares, stops, departureDate, departureTime, arrivalDate, arrivalTime, count(*) AS numOfReservations FROM flight JOIN reservation USING(flightNum) GROUP BY flightNum ORDER BY numOfReservations DESC;";
