...
<body>
	...
	try{
		...
		String checkForDuplicateReservationQuery = "SELECT * FROM reservationflights JOIN reservations USING(reservationCode) Where flightNum = '" + flightNum + "' AND accountNum = '" + accountNum + "' AND travelDate >= CURDATE();";
		...
		ps.setInt(1, Integer.parseInt(flightNum));
		...
		String updateAvailableSeatsQuery = "UPDATE flight SET availableSeats = (availableSeats - '" + numberOfPassengers + "') WHERE flightNum = '" + request.getParameter("one-way") + "';";
		
		stmt.executeUpdate(updateAvailableSeatsQuery);
