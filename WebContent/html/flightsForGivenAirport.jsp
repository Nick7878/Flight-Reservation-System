...
<body>
	...
	try{
		...
		String str = "SELECT DISTINCT flightNum, airline, airportTo, airportFrom, workingDays, numOfSeats, fares, stops, departureDate, departureTime, arrivalDate, arrivalTime FROM flight JOIN reservation USING(flightNum) JOIN flies USING(flightNum) JOIN airport USING(airportID) WHERE airportCode = '" + airportCode + "';";
